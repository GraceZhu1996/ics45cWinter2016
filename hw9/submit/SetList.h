/* (35 pts) Write a class SetList and a class iterator inside class SetList that allows forward iteration through it.
x   Each ListNode will have info, next like we did in the past with singly linked list.  */
...
private:
    struct ListNode
    {
        ...
        // static void insert(ListNode * L, T newInfo)
        //     {
        //         L = new ListNode(newInfo, L);
        //     }
...
public:
    ...
    class const_iterator
    {
        ...
        typedef ListNode* pointer;
        //typedef ptrdiff_t difference_type;
        //this one does not work in openlab
    private:
        pointer head;
    public:
